...
export const getAdvertisementList = createAsyncThunk(
    ...
    async (params: AdvertisementListDataType, thunkApi) => {
        try {
            const response = await getAdvertisementListHandler(
                params.filter,
                params.keyword,
                params.page
            );
...
export const getAdvertisementInquiryList = createAsyncThunk(
    ...
    async (params: AdvertisementInquiryListDataType, thunkApi) => {
        try {
            const response = await getAdvertisementInquiryListHandler(
                params.keyword,
                params.page
            );
            return response;
...
// 기타 문의 상태 변경
export const setAdvertisementProgress = createAsyncThunk('POST/setAdvertisementInquiry',
    async( data : setAdvertisementInquiryType, thunkApi ) => {
    try{
        const response = await setAdvertisementInquiryProgressHandler( data.checkList );
