...
import { MemberTableBody, MemberTableBodyRowSpan, MemberCheckBoxWrapper, MemberInputCheckBox, MemberLabelCheckBox, MemberTableBodyButton } from "./MagazineListTableBodyForm.styled";

import { MemberAction } from "redux/modules/MemberSlice";
import { useAppDispatch, useAppSelector } from "store/rootReducer";
import { useNavigate } from "react-router";

import { MemberTableProps } from "../MagazineListTableForm";
...
const MagazineListTableBodyForm = ({ offset, postsPerPage, totalContentsCount, banMemberHandler, unbanMemberHandler }: MemberTableProps) => {
