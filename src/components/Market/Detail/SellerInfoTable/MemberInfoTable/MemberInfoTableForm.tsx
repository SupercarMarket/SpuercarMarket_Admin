        ...
        <MemeberTable>
          <tbody>
            <tr>
              ...
              <MemberContent>{String( detailItem?.dealerInfo.dlrSeq ).padStart( 7, '0' )}</MemberContent>
            ...
            <tr>
              ...
              <MemberContent>{detailItem?.dealerInfo.userNickName}</MemberContent>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <MemberContent>{detailItem?.dealerInfo.createdDate.split("T")[0]}</MemberContent>
              <MemberHeader>회원등급</MemberHeader>
              <MemberContent>{ userRating[ detailItem?.dealerInfo.userRating as string ] }</MemberContent>
            </tr>
            <tr>
              <MemberHeader>Role</MemberHeader>
              <MemberContent>일반</MemberContent>
              <MemberHeader>게시글 수</MemberHeader>
              <MemberContent>{ String( detailItem?.dealerInfo.postCount ).padStart(3, '0')}개</MemberContent>
            </tr>
            <tr>
              <MemberHeader>댓글 수</MemberHeader>
              <MemberContent>{ String( detailItem?.dealerInfo.commentCount ).padStart( 3, '0' ) }개</MemberContent>
            </tr>
          </tbody>
        </MemeberTable>
      </MemberInfoWrapper>
