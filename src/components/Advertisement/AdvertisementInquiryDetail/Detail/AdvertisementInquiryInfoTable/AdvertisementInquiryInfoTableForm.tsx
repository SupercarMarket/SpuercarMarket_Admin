...
const AdvertisementInquiryInfoTableForm = () => {
    const {inquiryDetail, inquiryDetailAttachment} = useAppSelector(state => state.AdvertisementSlice);
            ...
            <AdvertisementWrapper>
                ...
                <AdvertisementDetailTable>
                            ...
                            { inquiryDetailAttachment?.map( item => {
                                return (
                                    <DownLaodFileInputButtonWrapper key={ item.originName }>
                                        ...
                                        <DownLaodButton style={{ width:"105px"}} onClick={ () => downloadFileFromURL( item.originName, item.attUrl )}>다운로드</DownLaodButton>
                                    </DownLaodFileInputButtonWrapper>
                                )
                            })}
                        {/*</DownLaodFileContentWrapper>*/}
                    ...
                    <tr>
                        ...
                        <TableContent colSpan={4}>{inquiryDetail?.rejectReason}</TableContent>
                    </tr>
                    </tbody>
                </AdvertisementDetailTable>
            </AdvertisementWrapper>
